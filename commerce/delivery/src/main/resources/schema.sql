...
(
    ...
    FOREIGN KEY (from_address_id) REFERENCES delivery.addresses (address_id) ON DELETE CASCADE,
    FOREIGN KEY (to_address_id) REFERENCES delivery.addresses (address_id) ON DELETE CASCADE
);